...
">
  <p style="font-size: 1.2em;">
    ¡Tenerte con nosotros en nuestro día de boda es el mayor regalo! Si deseas apoyarnos mientras comenzamos este nuevo capítulo de nuestras vidas, por favor sigue el link de la mesa de regalo.
  </p>
</div>
...
<div style="display: flex; flex-direction: column; gap: 20px; max-width: 500px; margin: 40px auto;">
  ...
  " onmouseover="this.style.transform='scale(1.03)';this.style.boxShadow='0 6px 10px rgba(0,0,0,0.1)'" 
    ...
    <strong style="font-size: 1.4em;">Mesa de Regalos Zola</strong>
  </a>
